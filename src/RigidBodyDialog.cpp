#include "RigidBodyDialog.hpp"

void RigidBodyDialog::LoadSceneTree2Combo(wxComboBox * cmbo, Robotarium::graphic::SceneNodePtr& startingNode)
{
...
RigidBodyDialog::RigidBodyDialog(wxFrame* _parent, Robotarium::graphic::SceneNodePtr* _parentSceneNode, const std::string title, DlgType dlgType)
